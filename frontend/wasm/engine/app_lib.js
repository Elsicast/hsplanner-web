 ...
 * @returns {string}
 */
export function invoke_cmd(cmd, args_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        const ptr1 = passStringToWasm0(args_json, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
        const len1 = WASM_VECTOR_LEN;
        wasm.invoke_cmd(retptr, ptr0, len0, ptr1, len1);
 ...
 * @param {Function} cb
 */
export function set_progress_callback(cb) {
    wasm.set_progress_callback(addHeapObject(cb));
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('app_lib_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
